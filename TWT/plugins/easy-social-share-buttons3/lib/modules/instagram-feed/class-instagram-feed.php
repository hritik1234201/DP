...
class ESSBInstagramFeed {
	...
	public function __construct() {
		...
		/**
		 * Since 7.6 - deactivate on a mobile device
		 */
		if (essb_option_bool_value('instagram_deactivate_mobile') && essb_is_mobile()) {
		    add_shortcode('instagram-feed', function() { return ''; });
		    return;
		}
