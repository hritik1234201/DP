...
ESSBOptionsStructureHelper::field_switch_panel('instagram', 'instagram', 'instagram_deactivate_mobile', esc_html__('Deactivate on mobile', 'essb'), esc_html__('Don\'t show feed code on mobile devices. If you have a cache plugin the option will work if it supports separate mobile caching.', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'), '', '');
