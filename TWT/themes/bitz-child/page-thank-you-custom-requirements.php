<?php
/* Template Name: Thank You Page (Custom Requirements)*/
                            ...
                            while (have_posts()) : the_post();
                                ...
                                <div style="margin: 0 auto;width:100%;text-align:center; border-bottom: 1px solid #e1e1e1; box-shadow: 0px 1px 4px #e1e1e1;">
                                    ...
                                    <?php if(!empty($custom_thankyou_message1)){ ?>
                                            <h1 style="font-size:25px;text-align: center;padding: 10px 0;font-family:'lato';margin-bottom:0px;">
                                   ...
                                   <?php }?>
                                    ...
                                    <p style="font-size:28px;text-align: center;padding: 10px 0 0px 0px;color: #052F85;margin-bottom: 0px;font-weight:600">
                              ...
                              <div class="td-related-row container">
                                <div style="margin-bottom: 30px !important;margin-top: 30px !important;margin-left: 20px;" class="heading_wrapper">
                                    <h2>RELATED RESOURCES</h2><div class="heading-line" style="background-color:#e2e2e2"><span style="background-color:#052F85"></span>
                                    </div>
                                </div>
