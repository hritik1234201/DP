            ...
            <div class="ur-form-grid" style="width: 100%; overflow: auto;">			
                <div class="table-responsive user-registration-profile-fields">
                    ...
                    $downloads = $wpdb->get_results(""
                            ...
                            . "FROM wp_o0gCImmh0o00eqjs_sdm_downloads as sdm "
                            . "LEFT JOIN wp_o0gCImmh0o00eqjs_posts p ON sdm.post_title = p.post_title "
...
//                                $url = "https://tools.keycdn.com/geo.json?host={$download->visitor_ip}";
								...
								$url = "http://ip-api.com/json/{$download->visitor_ip}?key=D85DpIqP6D4LWSvbF4CGrnY2uOYe1Xb46Dqh7yX08RRuuq1am7";
