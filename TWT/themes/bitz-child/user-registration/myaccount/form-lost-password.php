	...
	<form method="post" class="user-registration-ResetPassword lost_reset_password">
		<div class="ur-form-row">
			<div class="ur-form-grid">
				<p><?php echo apply_filters( 'user_registration_lost_password_message', __( 'Lost your password? Please enter your business email address. You will receive a link to create a new password via email.', 'user-registration' ) ); ?></p>
				...
				<p class="user-registration-form-row user-registration-form-row--first form-row form-row-first">
					...
					<!--<i class="fa fa-envelope-o icon"></i>-->
                                        <input class="user-registration-Input user-registration-Input--text input-text" type="text" name="user_login" placeholder="Enter your business email here *" id="user_login" />
				</p>
				</div>
