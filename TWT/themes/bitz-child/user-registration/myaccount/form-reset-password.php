		...
		<div class="ur-form-row">
			<div class="ur-form-grid">
				...
				<p class="user-registration-form-row user-registration-form-row--first form-row form-row-first">
					...
					<i class="fa fa-key icon"></i> <input type="password" class="user-registration-Input user-registration-Input--text input-text" placeholder="Enter your new password here *" name="password_1" id="password_1" />
				</p>
				</div>
				...
				<p class="user-registration-form-row user-registration-form-row--last form-row form-row-last">
					...
					<i class="fa fa-key icon"></i> <input type="password" class="user-registration-Input user-registration-Input--text input-text" placeholder="Re-enter your new password here *" name="password_2" id="password_2" />
				</p>
				</div>
