            ...
            <div class="ur-form-grid" style="width: 100%; overflow: auto;">
                <div class="table-responsive user-registration-profile-fields"> 
                    ...
                    $logins = $wpdb->get_results(""
                            . "SELECT * "
                            . "FROM wp_o0gCImmh0o00eqjs_fa_user_logins as logins "
                            . "WHERE user_id LIKE '{$curr_user->ID}' ORDER BY id DESC LIMIT 19;"
                    );
//                    if($curr_user->ID == 138) {
//                        echo '<pre>';
//                        print_r($logins);
...
//                    }
                    ...
                    $registered = $wpdb->get_row(""
                            ...
                            . "FROM wp_o0gCImmh0o00eqjs_users "
...
//                                $url = "https://tools.keycdn.com/geo.json?host={$login->ip_address}";
								...
								$url = "http://ip-api.com/json/{$login->ip_address}?key=D85DpIqP6D4LWSvbF4CGrnY2uOYe1Xb46Dqh7yX08RRuuq1am7";
								//$url = "http://ipapi.co/json/{$login->ip_address}?key=D85DpIqP6D4LWSvbF4CGrnY2uOYe1Xb46Dqh7yX08RRuuq1am7";
								
								
								
								//$url = "http://api.ipstack.com/{$login->ip_address}?access_key=e27c394d44589ff121b673b573e6f05a";
                            ...
                            <?php }
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?php //echo (isset($json['data'])) ? $json['city'].', '.$json['region'].', '.$json['country'] : '-'; ?><?php echo $json['city'].', '.$json['region'].', '.$json['country']; ?></td>
                                </tr>
                        </tbody>
                    </table>
                    ...
                    <?php 
                    echo "<span style='font-size:14px;line-height:17px;'><p style='margin-bottom:10px;'>Please <a target='_blank' href='".site_url('contact-us')."'>Contact Us</a> if you have any policy-related (<a target='_blank' href='https://privacyportal.onetrust.com/webform/e32c5e49-85c5-4969-bfa8-8cde49952e1f/ca578cee-9862-432c-a50e-8c9f175c333e'>Do Not Sell My Personal Information</a> or <a target='_blank' href='https://anteriad.com/privacy-policy#your-california-rights-and-choices'>Your California CCPA Rights</a>) or your personal data-related questions or if you want us to delete your information.</p><p>We will respond within our standard policy guidelines.</p>"
                    ?>
                    </div>
                </div>
            </div>
