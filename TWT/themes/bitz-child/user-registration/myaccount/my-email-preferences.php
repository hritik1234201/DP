...
button#unsubscribe-all-btn{
    ...
    font-size: 14px !important;
    line-height: 1 !important;
    border: 1px solid #009eed !important;
    letter-spacing: -.02rem !important;
    padding: 12px 30px !important;
    float: right;
    font-weight: 700;
...
<div class="ur-form-row">
    <div class="ur-form-grid my-account-content-block my-account-email-preferences">
        <div>
            <h2>Email Newsletter Preferences </h2>
            <button class="pull-right btn btn-primary" id="subscribe-all-btn">Subscribe to all</button>
            <div class="clearfix"></div>
        </div>
        <div class="preference-block mysubscribe">
            <p style='text-align:left;font-weight:700;padding: 10px 0px;'>To receive your personalized newsletter, manage your newsletter preferences here.</p>
            <?php
            foreach ($user_groups->suppressions as $single_group) {
                ...
                <div class="unsub-group td-pb-span12">
                    <div class="child-unsub-group">
                        <div class="grp-row1">
                            <h4 style="margin-bottom:5px;font-size: 24px !important;color:#000000;"><?php echo $single_group->name; ?></h4>
                        </div>
                        <div class="grp-row2"><p style="margin-bottom:5px;font-size: 18px;">
                        ...
                        <div class="grp-row3">
                            ...
                            <div class="custom-control custom-switch">
                                ...
                                <label class="custom-control-label" for="customSwitches-<?php echo $single_group->id; ?>">Select to Subscribe/Un-subscribe</label>
                            </div>
