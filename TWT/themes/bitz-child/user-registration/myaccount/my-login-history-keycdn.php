            ...
            <div class="ur-form-grid" style="width: 100%; overflow: auto;">
                <div class="table-responsive user-registration-profile-fields"> 
                    ...
                    $logins = $wpdb->get_results(""
                            . "SELECT * "
                            . "FROM wp_VzQCxSJv7uLSE_fa_user_logins as logins "
                    ...
                    <table id="table_id" class="display">
                        ...
                        <tbody>
                            ...
                            <?php }
                                ...
                                <tr>
                                    <td class="text-left"><?php 
                                        $timezone = (isset($json['data'])) ? $json['data']['geo']['timezone'] : 'UTC';
                                    ...
                                    <td class="text-left"><?php echo (isset($json['data'])) ? $json['data']['geo']['city'].', '.$json['data']['geo']['region_name'].', '.$json['data']['geo']['country_name'] : '-'; ?></td>
                                </tr>
                        </tbody>
                    </table>
