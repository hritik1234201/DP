...
<style>
    ...
    */
    ...
    .lost_reset_password .user-registration-Button, #register_button {
        ...
        border-color: #052F85 !important;
    }
    .user-registration input[type=text], .user-registration input[type=url], .user-registration input[type=tel], .user-registration input[type=email], .user-registration input.input-text {
        width: 100%;
    }
            ...
            <div class="ur-form-grid">
                <div class="ur-field-item field-user_email">
                    <div class="form-row validate-required user-registration-validated td-login-inputs" id="user_email_field" data-priority="">
                        <input data-rules="" data-id="user_email" placeholder="Business Email *" type="email" class="input-text input-email ur-frontend-field td-login-input" name="user_email" id="user_email" value="" required="required" data-label="User Email" aria-invalid="true" onkeypress="return event.keyCode != 13;">
            ...
            <div class="ur-form-grid set-relative">
                <div class="ur-field-item field-user_pass">
                    <div class="form-row validate-required user-registration-validated td-login-inputs set-relative" id="user_pass_field" data-priority="">
                        <input data-rules="" data-id="user_pass" type="password" placeholder="Password *" class="input-text input-password ur-frontend-field td-login-input" name="user_pass" id="user_pass" value="" required="required" data-label="Password" aria-invalid="true" onkeypress="return event.keyCode != 13;">
            ...
            <div class="ur-form-grid">
                <div class="ur-field-item field-select">
                    <div class="form-row validate-required td-login-inputs" id="company_name_field" data-priority="">
                        <input data-rules="" data-id="company_name" placeholder="Company Name *" type="text" class="input-text input-text ur-frontend-field td-login-input" name="company_name" id="company_name" value="" required="required" data-label="Company Name" maxlength="20" aria-invalid="true" onkeypress="return event.keyCode != 13;">
            ...
            <div class="ur-form-grid">
                <div class="ur-field-item field-first_name">
                    <div class="form-row validate-required td-login-inputs" id="first_name_field" data-priority="">
                        <input data-rules="" data-id="first_name" placeholder="First Name *" type="text" class="input-text input-text ur-frontend-field td-login-input" name="first_name" id="first_name" value="" required="required" data-label="First Name" aria-invalid="true" onkeypress="return event.keyCode != 13;">
            ...
            <div class="ur-form-grid">
                <div class="ur-field-item field-last_name">
                    <div class="form-row td-login-inputs" id="last_name_field" data-priority="">
                        <input data-rules="" data-id="last_name" type="text" placeholder="Last Name *" class="input-text input-text ur-frontend-field td-login-input" name="last_name" id="last_name" value="" required="required" data-label="Last Name" aria-invalid="true" onkeypress="return event.keyCode != 13;">
            ...
            <div class="ur-form-grid">
                <div class="ur-field-item field-newsletter_check">
                    <label class="user-registration-form__label user-registration-form__label-for-checkbox inline container-label set-relative">
                        <input class="user-registration-form__input user-registration-form__input-checkbox register_check form-margin-top-0" name="newsletter_check" type="checkbox" id="newsletter_check" value="forever" /> <span><?php _e('Yes, I want to receive emails from TechWeb Trends that may be of interest to me.', 'user-registration-terms'); ?></span>
                ...
                <div class="ur-field-item field-privacy_check">
                    <label class="user-registration-form__label user-registration-form__label-for-checkbox inline container-label set-relative">
                        <input class="user-registration-form__input user-registration-form__input-checkbox register_check form-margin-top-0" name="privacy_check" type="checkbox" id="privacy_check" value="forever" required="true" /> <span>
                            By registering, I agree to The TechWeb Trends (c/o Anteriad) <a class="form-check-a" href="https://techwebtrends.com/terms-of-service" target="_blank">Terms of Service</a> and <a class="form-check-a" href="https://anteriad.com/privacy-policy/" target="_blank">Privacy Policy</a>. I also understand that I can review and update my marketing preferences at any time. 

                           <!--  I understand by creating an account, I agree to TechWeb Trend's <a class="form-check-a" href="<?php //echo site_url('terms-of-service') ?>">Terms of Use</a> and <a class="form-check-a" href="https://anteriad.com/privacy-policy/" target="_blank">Privacy Policy</a> and that I may review and update my marketing preferences at any time. -->
                        <!--  Check this to turn on GDPR related features and enhancement. Read our <a class="form-check-a" href="<?php //echo site_url('general-data-protection-regulation'); ?>">GDPR DOCUMENTATION</a> to learn more.<abbr class="required" title="required">*</abbr></span> -->
                        <span class="checkmark"></span>
                    </label>
                    <!--</div>-->
                </div>
...
<?php do_action('user_registration_form_registration_end', $form_id); ?>
    ...
    <div class="back-to-home" style="margin-top: 18px;">
        <a href="<?php echo site_url('sign-in');?>"><i class="fa fa-chevron-left" aria-hidden="true"></i>  <u>Already have an account? Sign In</u></a>
    </div>
