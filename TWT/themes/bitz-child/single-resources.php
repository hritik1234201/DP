...
<?php //} ?>
                    ...
                    <div class="row2-col2 wpb_column vc_column_container vc_col-sm-5 vc_col-xs-12 column" style="border: 1px solid #777a72;padding: 20px 10px 0 10px;">
                        <div class="inner-col2">
						 ...
						 <p style="font-size: 12px;" class="fastpass-info alert alert-info">
                            ...
                            <h4 id="lp-form-head" style='font-weight: bold;font-size: 1.1rem;margin-left: 8px;margin-bottom:0px'>Get Exclusive Access to the <?php echo $category->name; ?></h4>
                            ...
                            <span id="privacy_policy"><input type="checkbox" required="required">
                                    ...
                                    <?php } else if (!empty($privacy_policy)) { ?>
                                        <span id="privacy_policy"><input type="checkbox"><?php echo $privacy_policy; ?> 
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <span id="privacy_policy"><input type="checkbox">
