                    ...
                    <body style="-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;max-width:720px;margin: 0 auto;font-size: 15px;line-height: 28px;color: #333333;font-family : Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol;">
                        ...
                        <div lang="en" style="" role="article" aria-label="An email from Your Brand Name">
                            ...
                            <div role=article aria-label="An email from Your Brand Name" lang=en class="main-div" style="font-weight:400;margin:0 auto;padding:0 20px 40px 20px;color: #333333;">
                                ...
                                $query = "SELECT * FROM `wp_posts` as p LEFT JOIN wp_postmeta pm ON p.id = pm.post_id AND pm.meta_key LIKE 'post_views_count'  WHERE post_date >= '" . date('Y-m-01') . "' AND post_date < '" . date('Y-m-t') . "' AND post_type IN ('resources') AND post_status = 'publish' GROUP BY WEEKOFYEAR(post_date) ORDER BY p.`post_date` ASC LIMIT 0, 4";
                                ...
                                $query = "SELECT * FROM wp_posts p LEFT JOIN wp_postmeta pm ON p.id = pm.post_id AND pm.meta_key LIKE 'post_views_count' JOIN wp_term_relationships tr ON p.id = tr.object_id AND term_taxonomy_id = 42 WHERE post_date >= '" . date('Y-m-01') . "' AND post_date < '" . date('Y-m-t') . "' AND post_type IN ('post') AND post_status = 'publish' ORDER BY pm.meta_value DESC LIMIT 0, 1";
                                ...
                                $query = "SELECT * FROM wp_posts p LEFT JOIN wp_postmeta pm ON p.id = pm.post_id AND pm.meta_key LIKE 'post_views_count' JOIN wp_term_relationships tr ON p.id = tr.object_id AND term_taxonomy_id = 43 WHERE post_date >= '" . date('Y-m-01') . "' AND post_date < '" . date('Y-m-t') . "' AND post_type IN ('post') AND post_status = 'publish' ORDER BY pm.meta_value DESC LIMIT 0, 1";
                                $result = $wpdb->get_row($query, OBJECT);
                                $i = 0;
                                $total_count = count($results);
                                $shown_sponsored = 'false';
                                ...
                                $query = "SELECT * FROM wp_posts p LEFT JOIN wp_postmeta pm ON p.id = pm.post_id AND pm.meta_key LIKE 'post_views_count' JOIN wp_term_relationships tr ON p.id = tr.object_id AND term_taxonomy_id = 41 WHERE post_date >= '" . date('Y-m-01') . "' AND post_date < '" . date('Y-m-t') . "' AND post_type IN ('post') AND post_status = 'publish' ORDER BY pm.meta_value DESC LIMIT 0, 1";
                                $result = $wpdb->get_row($query, OBJECT);
                                $i = 0;
                                $total_count = count($results);
                                $shown_sponsored = 'false';
                                ...
                                $query = "SELECT * FROM wp_posts p LEFT JOIN wp_postmeta pm ON p.id = pm.post_id AND pm.meta_key LIKE 'post_views_count' JOIN wp_term_relationships tr ON p.id = tr.object_id AND term_taxonomy_id = 44 WHERE post_date >= '" . date('Y-m-01') . "' AND post_date < '" . date('Y-m-t') . "' AND post_type IN ('post') AND post_status = 'publish' ORDER BY pm.meta_value DESC LIMIT 0, 1";
                                $result = $wpdb->get_row($query, OBJECT);
                                $i = 0;
                                $total_count = count($results);
                                $shown_sponsored = 'false';
...
//                                    </tbody>
//                                </table>';
                                $query = "SELECT * FROM wp_posts p LEFT JOIN wp_postmeta pm ON p.id = pm.post_id AND pm.meta_key LIKE 'post_views_count' WHERE post_date >= '" . date('Y-m-01') . "' AND post_date <= '" . date('Y-m-t') . "' AND post_type IN ('news') AND post_status = 'publish' GROUP BY WEEKOFYEAR(post_date) ORDER BY pm.meta_value DESC, p.post_date ASC LIMIT 0, 5";
