...
//                            $output = json_decode($response);
                            ...
                            //Status is Active
                            ?>
                            <div class="alert alert-danger" style="display:none" class="subscribe-msg">You're already subscribed to our newsletter. Please check and update your newsletter preferences <a href="<?php echo site_url('subscribe?email_id=' . base64_encode($email_id)) ?>" style="color:inherit;text-decoration:underline;">HERE</a></div>
                            <?php
                        }
                    } else {
            ...
            <div class="td-pb-span12 td-main-content" role="main">
                <div class="td-ss-main-content">
                    ...
                    <div class="td-page-content tagdiv-type thank-you-page" style="margin:1% auto 0 auto;">
                        <h1>Congratulations!! You have subscribed for TechWeb Trends Newsletter.  </h1>
                        <p style="font-family: helvetica, sans-serif;font-size:15px;color:#333;margin-top:20px;">You can always manage your newsletter preferences<a href="https://techwebtrends.com/my-account/email-preferences"> here.</a></p>
                    </div>
                </div>
            </div>  
        </div>
