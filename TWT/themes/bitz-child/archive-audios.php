...
//                    $cat = $category->term_id;
                    ...
                    if ($cat == "343") {
                        ...
                        <div class="wpb_column12 vc_column_container latestmoreBox latestblogBox vc_col-lg-12 vc_col-xs-12 vc_col-md-12 vc_col-sm-12" style="padding-left: 20px;padding-right: 20px;">
                            ...
                            <div class="td-image-container123 container123 vc_col-lg-4 vc_col-xs-12 vc_col-md-4 vc_col-sm-4">
                            ...
                            <div class="td-module-meta-info1234 vc_col-lg-8 vc_col-xs-8 vc_col-md-8 vc_col-sm-8" style="padding: 0px 15px 15px;">
                <?php
                $categories = get_the_terms($post->ID, 'audios_types');
                foreach ($categories as $category) {
                    ?>
