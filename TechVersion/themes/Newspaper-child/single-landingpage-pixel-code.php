<?php
/* Template Name: Landing Page With New Pixel Code - Custom Req
...
if($title == 'The Era of Multi-Cloud Services Has Arrived'){ 
echo "<script src='https://js.adsrvr.org/up_loader.1.1.0.js' type='text/javascript'></script>
