...
if (have_posts()) {
    ...
    while ( have_posts() ) : the_post();
        if( $column_count == 1 ) { ?>
            <div class="td-block-row archive-videos">
        <?php } ?>

            <div class="videos1 td-block-<?php echo esc_attr( $span ) ?>">
                <div <?php post_class('td_module_1 td_module_wrap ') ?> >
                        ...
                        <div class="td-module-thumb">
                            ...
                            <a href="<?php the_permalink() ?>" rel="bookmark" class="td-image-wrap" title="<?php the_title_attribute() ?>">
                                ...
                                <div class="centered" style="">
                                    <i class="fa fa-play" style="font-size:48px;color:#ffffff"></i>
                                </div>
                            </a>
                        </div>
