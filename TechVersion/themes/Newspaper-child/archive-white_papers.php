...
get_header();
    ...
    if (is_day()) {
        ...
        $td_archive_title .= __('White Papers', 'newspaper');
    }
...
?>
    ...
    <div class="td-main-content-wrap td-container-wrap">
        ...
        <div class="entry-crumbs td-crumb-container breadcrum"><span><a title="" class="tdb-entry-crumb" href="#">Home</a></span> <i class="td-icon-right td-bread-sep"></i> <span> <span><?php echo esc_html( $td_archive_title ) ?></span></span> </div>
