                    ...
                    <body style="-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;max-width:720px;margin: 0 auto;font-size: 15px;line-height: 28px;color: #333333;">
                        ...
                        <div lang="en" style="" role="article" aria-label="An email from Your Brand Name">
                            ...
                            <div role=article aria-label="An email from Your Brand Name" lang=en class="main-div" style="font-weight:400;margin:0 auto;padding:0 20px 40px 20px;color: #333333;">
                                ...
                                <table width=100% border=0 style="margin-bottom: 30px;border-bottom: 1px solid #ddd">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td height=50 style="width:100%;padding: 0 0 0px 0;width:40%;text-align:right;"><h2 style='color:#7F8182;font-size:25px;font-family:Gelasio'>Daily Alert</h2>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <!-- {{{email_content}}} -->
                                <?php
                                $query = "SELECT * FROM `wp_bnv0rGfv3VUz1uZPDMKp_posts` WHERE post_date >= '" . date('Y-m-d',strtotime('-1 day')) . "' AND post_date < '" . date('Y-m-d') . "' AND post_type IN ('news') AND post_status = 'publish' ORDER BY `wp_bnv0rGfv3VUz1uZPDMKp_posts`.`post_date` DESC LIMIT 0, 1";
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" style="width: 100%">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?php echo get_the_permalink($result->ID); ?>"><img style="text-align:center;-ms-interpolation-mode:bicubic;border:0;height:auto;line-height:100%;outline:0;text-decoration:none; max-width: 100%;max-height: 100%;display: block;" src="<?php echo esc_url(get_the_post_thumbnail_url($result->ID, 'full')) ?>" alt="<?php echo $result->post_title; ?>" title="<?php echo $result->post_title; ?>" /></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 10px 0">
                                            <p><strong><?php echo '<a class="text-para" style="color: inherit;text-decoration: none;font-weight: inherit;font-size: inherit;" href="' . get_the_permalink($result->ID) . '">' . $result->post_title . '</a>'; ?></strong></p>
                                            <p><?php
                                            ...
                                            <p><a class="link-btn" style="background-color: #4c4084;color: #FFF;font-size: 11px !important;line-height: 35px !important;letter-spacing: 1px !important;height: auto;border-radius: 1px;padding: 0 16px;box-sizing: border-box;text-decoration: none;display: inline-block;" href="<?php echo get_the_permalink($result->ID); ?>"> Read More </a></p>
                                        </td>
                                    </tr>
                                </table>
                                <?php
                                $query = "SELECT * FROM `wp_bnv0rGfv3VUz1uZPDMKp_posts` WHERE post_date >= '" . date('Y-m-d',strtotime('-1 day')) . "' AND post_date < '" . date('Y-m-d') . "' AND post_type IN ('news') AND post_status = 'publish' ORDER BY `wp_bnv0rGfv3VUz1uZPDMKp_posts`.`post_date` DESC LIMIT 1, 4";
                                ...
                                <?php
                                $query = "SELECT * FROM `wp_bnv0rGfv3VUz1uZPDMKp_posts` WHERE post_type IN ('news') AND post_status = 'publish' ORDER BY `wp_bnv0rGfv3VUz1uZPDMKp_posts`.`post_date` DESC LIMIT 5, 3";
                                $results = $wpdb->get_results($query, OBJECT);
                                $i = 0;
                                $total_count = count($results);
                                $shown_sponsored = 'false';
