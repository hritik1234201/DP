...
.login-form-col-1 {
	...
	background-image: url("https://techversions.com/wp-content/uploads/2021/02/Sign-in-Page-Banner.png"); 
    text-align: center;
    padding: 14% 10%;
                            ...
                            <div class=""><!--td-page-content tagdiv-type preference-block-->
                                ...
                                <div class="login-form-row">
                                    <div class="login-form-col-1">
                                        <a href="<?php echo home_url(); ?>"><img src="https://techversions.com/wp-content/uploads/2021/01/TV-Logo-243-x-22.png" /></a>
                                        <h1>Welcome to Techversions</h1>
                                    ...
                                    <div class="login-form-col-2">
                                        ...
                                        <div id="login-block" style="<?php echo ($currpage != 'register') ? 'display:block;' : 'display:none;'; ?>">
                                            ...
                                            <h4 class="text-center">Join The Techversions Legacy Now! Sign in to get full access.</h4>
											...
											<?php echo do_shortcode('[user_registration_form id="112503"]'); ?>
