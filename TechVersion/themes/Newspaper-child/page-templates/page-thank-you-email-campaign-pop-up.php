<?php
/* Template Name: Thank you page Template - Pop-up Custom Questions */
...
$cta_button_title = get_post_meta($post->ID, 'cta_button_title', true);
...
<style>
    ...
    body.page-template-page-thank-you-email-campaign-pop-up p {
        margin-bottom: 5px;
    }
</style>
                    ...
                    <div class="td-page-content tagdiv-type thank-you-page" style="margin:1% auto 0 auto;">
                        ...
                        if (have_posts()) {
                            while (have_posts()) : the_post();
                                ...
                                <!-- START -  Row 2-->
                                <div style="margin: 0 auto;width:100%;">                                                                                                            <div class="single-whitepaper track-links" style="width:1140px;margin: 0 auto;padding-bottom:30px;">
                                        <div class="td_block_wrap td_block_related_posts tdi_12_89f td_with_ajax_pagination td-pb-border-top td_block_template_12">
                                            <div style="margin-top: 40px;padding: 10px 5px;">
                                                <div class="row3-child1" style="display: flex; padding: 20px 5px; box-shadow: 0px 0px 3px 3px #ddd;">
                                                    <!--<div>-->
                                                    <div class="td-module-image" style="width:40%;margin: 0 20px 0 20px; background-image: url(<?php echo $image_link; ?>);background-size: cover;">
                                                    ...
                                                    <div class="item-details" style="width:60%;">
                                                        ...
                                                        <div class="" style='padding: 0 20px;'>
                                                            ...
                                                            <h3 style="font-weight: 900;margin-top:0;"> <?php echo $resource_title; ?></h3>
                                                            <?php the_content(); ?>
                                                            <div class="cta-button">
                                                                <a id="my_link" href="#open-custom-questions" name="my_link" target="_blank" rel="modal:open"><?php echo $cta_button_title; ?></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <span style="display:none;" id="pdf_link"><?php echo $pdf_link; ?></span> 
...
<?php } ?>
    ...
    function download_asset() {
        var email = '<?php echo $_GET["email"]; ?>';
        var pdf_link = '<?php echo $pdf_link; ?>';
        var form_id = '<?php echo $form_id; ?>';
        var current_url = '<?php echo $current_url; ?>';
        // console.log(pdf_link);
        if (jQuery(".form"+form_id+" div").hasClass('fm-message') == true) {
            console.log('testing once');
            window.open(pdf_link, '_blank');

            setTimeout(function () {
                window.location.href = current_url+"?email="+email+"&form_sub=true";
            }, 3000);
            stop_checking();
        }
    }
