<?php
/* Template Name: Automation Email, Right-side form
                ...
                <div class="row2" style="">
                    <div class="row2-col1 column" style="">
                        ...
                        $featured_image = get_the_post_thumbnail_url(null, 'medium_large');
                            ...
                            $lp_img_custom_field = get_post_meta($post->ID, 'lp_img_url', true);
                            if(!empty($lp_img_custom_field)) {
                                $featured_image = $lp_img_custom_field;
                                $style="width:auto;";
                            ...
                            if ($featured_image) {
                        ?>
                            <img src="<?php echo $featured_image; ?>" style="object-position: top left;<?php echo $style; ?>" />
                        <?php }  ?>
