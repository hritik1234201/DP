                    ...
                    <div class="row2-col1 column" style="">
                        ...
                        <?php
                            $featured_image = get_the_post_thumbnail_url(null, 'medium_large');
                             if ($featured_image) {
                        ?>
                            <!-- <img src="<?php echo $featured_image; ?>" style="width:500px;height:400px;object-fit: cover;" /> -->
...
<!--                                    <ul class="td-tags td-post-small-box clearfix">
                    ...
                    <div class="row2-col2 column" style="">
                        <div class="inner-col2">
                            ...
                            <span id="privacy_policy" style="margin-bottom: 20px;margin-top: -20px;font-size:11px;"><input type="checkbox" required="required">
                                    ...
                                    <?php } else if (!empty($privacy_policy)) { ?>
                                        <span class="checkbox-div" id="privacy_policy" style="margin-bottom: 20px;margin-top: -20px;font-size:11px;"><input type="checkbox"><?php echo $privacy_policy; ?> 
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <span class="checkbox-div" id="privacy_policy" style="margin-bottom: 20px;margin-top: -20px;font-size:11px;"><input type="checkbox">
