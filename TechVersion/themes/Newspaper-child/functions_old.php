...
include_once( get_stylesheet_directory() . '/inc/email-preview2.php');
...
function validate_email() {
    ...
    if ($msg == '' && $email != '') {
        ...
        if (in_array(strtolower($domain_arr[0]), array('yahoo', 'gmail', 'outlook', 'rediffmail', 'earthlink', 'att', 'livemore', 'protonmail', 'bellsouth', 'aol', 'zoho', 'mail', 'icloud', 'thunderbird', 'yandex', 'gmx'))) {
...
register_taxonomy("sponsored_by", [ "page", "white_papers", "e_books","posts", "tech_news", "events"], $args);
...
add_action('wp_ajax_nopriv_download_history_ajax', 'download_history_ajax_handler');
