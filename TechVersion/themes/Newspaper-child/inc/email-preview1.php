...
function preview_email_template() {
	...
	$tester_email = 'ramkiran@anteriad.com,gelumalai@anteriad.com';
	$daily_subject = 'Daily';
	$weekly_subject = 'Weekly';
	$monthly_subject = 'Monthly';
	...
	if(isset($_GET['newsletter']) && $_GET['newsletter'] == 'daily'){
        ...
        //Second Row
               //Second Row
               $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_type IN ('post') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` DESC LIMIT 1, 4";
               ...
               $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_type IN ('post') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` DESC LIMIT 6, 3";
               $results = $wpdb->get_results($query, OBJECT);
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
            <head>
              ...
              <![endif]-->
				...
				$below_content ='<table border="0" width="100%" style="width:100%; text-align: center;border-top:1px solid #ddd">
                                    <tr><td><p><a class="link-btn" style="text-decoration: none; font-size: 13px !important;color:#FFF;margin-top:20px;padding:5px 40px;background-color : #04a353;line-height : 35px !important ;letter-spacing : 0.5px !important ;height : auto;border-radius : 3px;box-sizing : border-box;text-decoration : none;display : inline-block;font-weight:600" href="https://techversions.com/blog/">  Read More Blogs   </a></p></td></tr>
                                </table>
                                <!--START - FOOTER-->
                                                ...
                                                <table align="center" style="-webkit-margin-start:auto;-webkit-margin-end:auto;">
                                                    <tbody><tr align="center"><td style="padding: 0px 5px;" class="social-icon-column">
                                                                ...
                                                                <a role="social-icon-link" href="https://twitter.com/tech_versions" target="_blank" alt="Twitter" title="Twitter">
                                                                    <img role="social-icon" alt="Twitter" title="Twitter" src="https://techversions.com/assets/Twitter-icon.png" />
                                                                </a>
                                                            </td><td style="padding: 0px 5px;" class="social-icon-column">
                                ...
                                <table border="0" cellspacing="0" cellpadding="10" style="background-color:#ebeeef;width: 100%">
                                    ...
                                    <tr>
                                        <td style="text-align: center;color:#04a353">
                                            ...
                                            <p>
                                                <a style="font-size: 13px;color:#04a353;font-weight : 600;text-decoration : none;" href="https://anteriad.com/contact-us/">Contact Us</a>
                                                <br />
                                                <a style="font-size: 13px;color:#04a353;font-weight : 600;text-decoration : none;" href="https://anteriad.com/terms-of-service/">Terms of service</a>
                                                <br/>
                                                <a style="font-size: 13px;color:#04a353;font-weight : 600;text-decoration : none;" href="https://anteriad.com/privacy-policy">Privacy Policy</a>
                                                <br/>
                                                ...
                                                <br/>
                                                <a href="'.site_url('my-account/email-preferences').'" style="font-size: 13px;color : #04a353;font-weight : 600;text-decoration : none;">Unsubscribe</a>
                                            </p>
                                            <address style="font-size: 13px; font-style: normal; font-weight: 400; line-height: 24px; color:#7F8182;width: 70%;margin: 30px auto 20px auto;">&copy; '.date('Y').' '.get_bloginfo('name').'. All rights reserved.<br/> 2 International Drive, Rye Brook, New York 10573, USA</address>
			...
			if(isset($_GET['sendgrid']) && $_GET['sendgrid'] == 'send'){
				...
				exit();
			}//else if(isset($_GET['wp_mail']) && $_GET['wp_mail'] == 'send'){	
    ...
    if(!empty($results)){
		...
		$i = 0;
		foreach ($results as $result) {
           $email_content .= '<td style="width: 50%;margin-right:10px;padding: 0 10px">'
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_type IN ('post') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` DESC LIMIT 0, 4";
    ...
    if (!empty($result1)) {
        foreach ($result1 as $single_result) {
            ...
            $email_content .= '<td style="padding: 0 0 10px 10px; width:60%">
                        ...
                        <div lang="en" role="article" aria-label="An email from '.get_bloginfo('name').'">
                            ...
                            <div role=article aria-label="An email from '.get_bloginfo('name').'" lang=en class="main-div" style="font-weight:400;margin:0 auto;padding:0 20px 40px 20px;color: #333333;">
                                ...
                                <table width=100% border=0 style="margin-bottom: 0;">
                                    <tbody>
                                        <tr>
                                            <td class="head-col1" height=50 style="width:100%;padding: 0 0 0px 0;width:60%"><img src="https://techversions.com/wp-content/uploads/2021/01/TV-Logo-243-x-22.png" alt="'.get_bloginfo('name').'" style="text-align:center;-ms-interpolation-mode:bicubic;border:0;height:auto;line-height:100%;outline:0;text-decoration:none; max-width: 100%;max-height: 100%;display: block;margin-bottom: 15px;" />
                                            </td>
                                            <td class="head-col2" height=50 style="width:100%;padding: 10px 0 0 0;width:40%;text-align:right;position: relative;"><h2 style="color:#7F8182;font-size:30px;font-family:Gelasio;margin-top:1px;">'.$monthly_subject.'</h2>
                                                <span style="position: absolute; top:40px;right:0;color: #7F8182;font-size: 12px;">'.date('F, Y').'</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>';
