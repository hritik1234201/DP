...
function preview_email_template(){
	...
	if(isset($_GET['newsletter']) && $_GET['newsletter'] == 'daily'){
        ...
        $query = "SELECT * FROM `".$wpdb->prefix."posts` WHERE post_type IN ('post') AND post_date >= '" . date('Y-m-d', strtotime('-1 day')) . "' AND post_status = 'publish' ORDER BY `".$wpdb->prefix."posts`.`post_date` ASC LIMIT 0, 3";
        ...
        if(!empty($result)){
         ...
         $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_type IN ('post') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` DESC LIMIT 5, 4";
         $results = $wpdb->get_results($query, OBJECT);
        
        if(!empty($results)){
		 $email_content .='<div style="background: #F8F8F8 0% 0% no-repeat padding-box;padding: 40px 40px 0px;">';
            foreach ($results as $result) {
                ...
                $para = $paragraph;
                $email_content .=  ' <a style="color:#0D0128;text-decoration:none;font-size:16px;font-weight:500;float:left" href="' . get_the_permalink($result->ID) . '">Read Now <img style="width:20px;float: right;padding-left: 10px;padding-top: 5px;"src="https://techversions.com/assets/Arrow-icon1.png"></a>';
                $email_content .= '</p>
                                                    </td>
                                                </tr>
                                            </table>';
        ...
        $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_type IN ('post') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` DESC LIMIT 9, 4";
              ...
              <![endif]-->
                    ...
                    <body style="-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;max-width:720px;margin: 0 auto;font-size: 15px;line-height: 28px;color: #333333;">
                        ...
                        <div lang="en" style="" role="article" aria-label="An email from "'.get_bloginfo('name').'">
                            ...
                            <tbody>
                                <tr>
                                    <td height=50 style="width:100%;padding: 10px 0 10px 0;width:100%;text-align:center"><a href="https://techversions.com/"><img src="https://techversions.com/wp-content/uploads/2021/01/TV-Logo-243-x-22.png" alt="TechVersions" style="text-align:center;-ms-interpolation-mode:bicubic;border:0;height:auto;line-height:100%;outline:0;text-decoration:none; max-width: 100%;max-height: 100%;display: inline-block;" /></a>
                                    </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <p style="color: #FFFFFF;margin:0px">'.date('d F Y').'</p>
                                </td>
				...
				$below_content ='<table border="0" width="100%" style="width:100%; text-align: center;">
                                    <tr><td><p><a class="link-btn" style="text-decoration: none; font-size: 18px !important;color:#FFF;margin-top:20px;padding:10px 60px;background-color : #04a353;line-height : 35px !important ;letter-spacing : 0.5px !important ;height : auto;border-radius : 50px;box-sizing : border-box;text-decoration : none;display : inline-block;font-weight:600" href="https://techversions.com/blog/" target="_blank">  Explore More   </a></p></td></tr>
                                </table>
                                <!--START - FOOTER-->
                                                ...
                                                <tbody><tr align="center"><td style="padding: 0px 5px;" class="social-icon-column">
                                                            <a role="social-icon-link" href="https://www.facebook.com/techversions" target="_blank" alt="Facebook" title="Facebook" style="">
                                                             ...
                                                             <a role="social-icon-link" href="https://twitter.com/tech_versions" target="_blank" alt="Twitter" title="Twitter">
                                                                <img role="social-icon" alt="Twitter" title="Twitter" src="https://techversions.com/assets/twitter-white1.png" style="width:20px;border-radius:20px;"/>
                                                            </a>
		...
		/*Starts newsletter_weekly_func*/
		 ...
		 global $wpdb;
        $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_date >= '" . date('Y-m-d', strtotime('-5 week')) . "' AND post_date < '" . date('Y-m-d', strtotime('-1 day')) . "' AND post_type IN ('tech_news') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` ASC LIMIT 0, 1";
        $result = $wpdb->get_row($query, OBJECT);
        $todays_post = $result;
    ...
    //Second Row
    $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_date >= '" . date('Y-m-d', strtotime('-5 week')) . "' AND post_date < '" . date('Y-m-d', strtotime('-1 day')) . "' AND post_type IN ('tech_news') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` ASC LIMIT 1, 2";
    $results = $wpdb->get_results($query, OBJECT);
    ...
    if(!empty($results)){
        ...
        foreach ($results as $result) {
           $email_content .= '<td style="width: 33%;margin-right:10px;padding: 0 20px">'
                    ...
                    . '<p><a class="link-btn" style="width:150px;text-decoration: none; font-size: 15px;color:#FFF;margin-top:20px;padding:5px 30px;background-color : #12A555;line-height : 35px !important ;letter-spacing : 1px !important ;height : auto;border-radius : 1px;box-sizing : border-box;text-decoration : none;display : flex;" href="' . get_the_permalink($result->ID) . '"> <img src="https://techversions.com/assets/Arrow-Icon-White.png" style="margin-left: -15%;
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
              ...
              <![endif]-->
                    ...
                    <body style="-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;max-width:720px;margin: 0 auto;font-size: 15px;line-height: 28px;color: #333333;">
                        ...
                        <div lang="en" style="" role="article" aria-label="An email from '.get_bloginfo('name').'">
                            ...
                            <div role=article aria-label="An email from Your '.get_bloginfo('name').'" lang=en class="main-div" style="font-weight:400;margin:0 auto;padding:0 0px 40px 0px;color: #333333;box-shadow: 0px 3px 6px #00000029;">
                                ...
                                <table width=100% border=0 style="margin-bottom: 30px;">
                                    <tbody>
                                        <tr>
                                           <td height=50 style="width:100%;padding: 0 0 0px 0;width:100%;text-align:center"><a href="https://techversions.com/"><img src="https://techversions.com/wp-content/uploads/2021/01/TV-Logo-243-x-22.png" alt="TechVersions" style="text-align:center;-ms-interpolation-mode:bicubic;border:0;height:auto;line-height:100%;outline:0;text-decoration:none; max-width: 100%;max-height: 100%;display: inline-block;" /></a>
                                    </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <tbody>
                            <tr>
                                <td height=40 style="width:100%;padding: 0 0 0px 0;width:100%;text-align:center; background:#12a555;box-shadow: 0px 3px 6px #00000029;">
                                <p style="font-size:19px;color:#FFFFFF;font-weight:400;margin:0;padding:10px 0px;">Weekly </p>
		...
		$below_content = '
                            ...
                            <tr>
                                <td style="text-align: center;color:#04a353;padding: 0px 40px 30px;">
                                    ...
                                    <p class="footerlink">
                                        <a style="font-size: 13px;color : #cdd2cf;font-weight : 600;text-decoration : none;padding-right:20px;" href="https://techversions.com/contact-us/">Contact Us</a>
                                      
                                        <a style="font-size: 13px;color : #cdd2cf;font-weight : 600;text-decoration : none;padding-right:20px;" href="https://techversions.com/terms-of-service/">Terms of service</a>

                                        <a style="font-size: 13px;color :#cdd2cf;font-weight : 600;text-decoration : none;padding-right:20px;" href="https://anteriad.com/privacy-policy/">Privacy Policy</a>
                                        <a style="font-size: 13px;color :#cdd2cf;font-weight : 600;text-decoration : none;padding-right:20px;" href="{{{manage_your_preferences_link}}}" >Manage Your Preferences</a>
                                        <a style="font-size: 13px;color :#cdd2cf;font-weight : 600;text-decoration : none;" href="<%asm_group_unsubscribe_raw_url%>" >Unsubscribe</a>
                                    </p>
                                    <address style="font-size: 14px; font-style: normal; font-weight: bold; line-height: 24px; color:#cdd2cf;;width: 70%;margin: 30px auto 3px auto;">&copy; {{{curr_year}}} TechVersions c/o Anteriad. All rights reserved.</address>
                                    <address style="font-size: 12px; font-style: normal; font-weight: 400; line-height: 24px; color:#cdd2cf;;width: 70%;margin: 0px auto 20px auto;">2 International Drive, Rye Brook, New York 10573, USA</address>
    ...
    $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_date >= '" . date('Y-m-d', strtotime('-1 week')) . "' AND post_date < '" . date('Y-m-d', strtotime('-1 day')) . "' AND post_type IN ('e_books','infographics','white_papers') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` ASC LIMIT 1, 4";
    $results = $wpdb->get_results($query, OBJECT);
    
    if(count($results) < 4){
        $query = "SELECT * FROM `{$wpdb->prefix}posts` WHERE post_type IN ('e_books','infographics','white_papers') AND post_status = 'publish' ORDER BY `{$wpdb->prefix}posts`.`post_date` DESC LIMIT 1, 4";
        $results = $wpdb->get_results($query, OBJECT);
    }
	...
	if(!empty($results)){
		...
		foreach ($results as $result) {
			if ($i == 0 || $i == 2) {
				...
				$email_content .= '<tr style="vertical-align: top;">';
			}
			if ($i == 1 || $i == 3) {
...
width: 20px;height: 20px;margin-top: 5%;"><span style="margin-left: 7%;color:#FFFFFF;font-size:14px;">Download</span></a></p>'
    ...
    if (!empty($result1)) {
        foreach ($result1 as $single_result) {
            ...
            $para = $paragraph;
            $email_content .= $para . ' <a style="color:#04a353;font-weight:600;text-decoration:none;font-size:16px;font-weight:400;" href="https://techversions.com/blog/">Read More</a>';
    ...
    if ($blogs_available) {
        ...
        $email_content .= '<table border="0" width="100%" style="width:100%; text-align: center;">
                                    <tr><td><p><a class="link-btn" style="text-decoration: none; font-size: 15px;color:#FFF;padding:5px 30px;background-color : #04a353;line-height : 35px !important ;letter-spacing : 1px !important ;height : auto;border-radius : 1px;box-sizing : border-box;text-decoration : none;display : inline-block;border-radius:3px;" href="https://techversions.com/blog/">  Read more Blogs   </a></p></td></tr>
                                </table>';
    }
    ...
    transform: skew(-30deg, 0deg);
                    ...
                    <body style="-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;max-width:720px;margin: 0 auto;font-size: 15px;line-height: 28px;color: #333333;">
                        ...
                        <div lang="en" role="article" aria-label="An email from '.get_bloginfo('name').'">
                            ...
                            <div role=article aria-label="An email from '.get_bloginfo('name').'" lang=en class="main-div" style="font-weight:400;margin:0 auto;padding:0 0px 40px 0px;color: #333333;box-shadow: 0px 3px 6px #00000029;">
                                ...
                                <table width=100% border=0 style="margin-bottom: 0;">
                                    <tbody>
                                        <tr>
                                            <td class="head-col1" height=50 style="width:100%;padding: 0 0 0px 0;"><center><img src="https://techversions.com/wp-content/uploads/2021/01/TV-Logo-243-x-22.png" alt="'.get_bloginfo('name').'" style="text-align:center;-ms-interpolation-mode:bicubic;border:0;height:auto;line-height:100%;outline:0;text-decoration:none; max-width: 100%;max-height: 100%;display: block;margin-bottom: 15px;" /></center>
                                            </td>
                        ...
                        <tbody>
                            <tr>
                                <td height=40 style="width:100%;padding: 0 0 0px 0;width:100%;text-align:center; background:#12a555;box-shadow: 0px 3px 6px #00000029;">
                                <p style="font-size:19px;color:#FFFFFF;font-weight:400;margin:0;padding:10px 0px;">'.date('F, Y').' </p>
...
//START -- Resource ROw
    ...
    //             }
        ...
        $below_content = ' <table border="0" width="100%" style="width:100%; text-align: center;background-color:#F2F2F2;padding-bottom:20px;">
                                    <tr><td><p></p></td></tr>
                                </table>
                            ...
                            <tr>
                                <td style="text-align: center;color:#04a353;padding: 0px 40px 30px;">
                                    ...
                                    <p class="footerlink">
                                        ...
                                        <a style="font-size: 13px;color :#cdd2cf;font-weight : 600;text-decoration : none;padding-right:20px;" href="https://anteriad.com/privacy-policy/">Privacy Policy</a>
                                        <a style="font-size: 13px;color :#cdd2cf;font-weight : 600;text-decoration : none;padding-right:20px;" href="{{{manage_your_preferences_link}}}" >Manage Your Preferences</a>
                                        <a style="font-size: 13px;color :#cdd2cf;font-weight : 600;text-decoration : none;padding-right:20px;" href="<%asm_group_unsubscribe_raw_url%>" >Unsubscribe</a>
                                    </p>
                                    <address style="font-size: 14px; font-style: normal; font-weight: bold; line-height: 24px; color:#cdd2cf;;width: 70%;margin: 30px auto 3px auto;">&copy; {{{curr_year}}} TechVersions c/o Anteriad. All rights reserved.</address>
                                    <address style="font-size: 12px; font-style: normal; font-weight: 400; line-height: 24px; color:#cdd2cf;;width: 70%;margin: 0px auto 20px auto;">2 International Drive, Rye Brook, New York 10573, USA</address>
                                    <address style="font-size: 11px; font-style: normal; font-weight: 400; line-height: 24px; color:#cdd2cf;">This newsletter cannot be copied, distributed, or displayed without prior written permission from TechVersions c/o Anteriad.</address>
