...
<html <?php language_attributes(); ?>>
    <head>
        <script data-ad-client="ca-pub-8383606277339659" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-157828259-1"></script>
        <script>
        ...
        <script>(function (w, d, s, l, i) {
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-N2BJZN6');</script>
...
<!--            <div class="landingpage-headmenu" style="width: 1068px;margin: 40px auto 0 auto;">
                    <a class="td-header-logo td-sticky-header" href="https://techversions.com/" data-wpel-link="internal">
                        <img src="https://techversions.com/wp-content/uploads/2020/02/Image20200212125837.png" alt="TechVersions" title="TechVersions">
                        <span class="td-visual-hidden">TechVersions</span>
                    </a>
            </div>-->
            ...
            ?>
                                        <a class="td-logo-wrap" href="<?php echo esc_url(home_url('/')); ?>">
                                            <span class="td-logo-text"><?php if (!$td_logo_text) {
                echo "NEWSPAPER";
            } else {
                echo esc_attr($td_logo_text);
            } ?></span>
                                        </a>
<?php
if ($td_use_h1_logo === true) {
...
?>
                                        <span class="td-tagline-text"><?php if (!$td_tagline_text) {
    echo "DISCOVER THE ART OF PUBLISHING";
} else {
    echo esc_attr($td_tagline_text);
} ?></span>
                                    </div>
                                </div>
                            </div>
