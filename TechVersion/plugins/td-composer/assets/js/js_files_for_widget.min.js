...
!0)}d||delete e[h]}break;case 3:f=d[0];k=d[2];for(t in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[t],f)){p=t;break}d=!1;for(m in c)if(f===c[m]&&m===p+"-"+k){d=!0;break}d||_.has(c,p+"-"+k)&&""===c[p+"-"+k]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0);d||delete e[h]}var x=[],q;for(q in window.tdcAdminSettings.listStyles[b])if(q===a){for(g=0;g<window.tdcAdminSettings.listStyles[b][q].length;g++)h=window.tdcAdminSettings.listStyles[b][q][g],_.isArray(h)?
...
c.length&&("popular1"===a||"popular2"===a||"popular3"===a||"popular7"===a?c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"))},toggleEnableCFParams:function(a){var c=a.find("option:selected").text().match(/\(([^)]+)\)$/);a=jQuery(".tdc-separator-url, .tdc-property-url, .tdc-property-open_in_new_window, .tdc-property-url_rel");var b=jQuery(".tdc-property-text_cut");c&&(c=c[1],"wysiwyg"===c||"user"===c||"taxonomy"===c?a.addClass("tdc-disabled"):
a.removeClass("tdc-disabled"),"text"===c||"textarea"==c?b.removeClass("tdc-disabled"):b.addClass("tdc-disabled"))},bindPanelToModel:function(a,c){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==a.cid||!_.isUndefined(c)&&(_.isUndefined(c)||!0===c)){c=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=a;for(var b=[],e=0;e<c.params.length;e++){var d=
tdcSidebarPanel._defaultGroupName;_.isEmpty(c.params[e].group)||(d=c.params[e].group);b.push(d)}b=_.uniq(b);var f=d="",g=tdcSidebar.getCurrentTabId(),k,n;d+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var h=n=k="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);var m=tdcUtil.makeSafeForCSS(f);0===e?(k='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',n='<a href="#" data-tab-id="td-tab-'+
...
"selected";break;case "phone":h="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "landscape":k="selected";break;case "portrait":n="selected";break;case "phone":h="selected"}d+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';tdcState.isMobileComposer()?d=d+('<div class="tdc-responsive-all tdc-responsive-tablet-landscape '+e+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div><div class="tdc-responsive-phone ')+
...
b){tdcSidebarPanel.toggleEnableBlockSortParams(jQuery(b))});c=jQuery('[data-tag="tdb_single_custom_field"] [data-param_name="acf_field"]');c.length&&tdcSidebarPanel.toggleEnableCFParams(c);var p=jQuery('[data-tag="vc_column"] [data-param_name="is_sticky"], [data-tag="vc_column_inner"] [data-param_name="is_sticky"]');if(p.length){var x=p.closest(".tdc-property-wrap");jQuery("body").on("click",".tdc-responsive-buttons > div",function(a){a=p.is(":checked");jQuery(this).hasClass("tdc-responsive-phone")?
(x.addClass("tdc-disabled"),p.prop("disabled",!0),p.prop("checked",!1)):(x.removeClass("tdc-disabled"),p.prop("disabled",!1),p.prop("checked",a))})}}},_bindGroupAndGetHtml:function(a,c,b){var e="",d=b.get("attrs");if("tdc_zone"===b.get("tag"))var f=d.type;for(var g=0;g<c.params.length;g++){var k=c.params[g].param_name,n=c.params[g].group;if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(c.params[g].group)||c.params[g].group===a){if(!_.isUndefined(f)){if(!_.isUndefined(c.params[g].zone_group)&&f!==
c.params[g].zone_group||"type"===k)continue;if("mob_load"===k&&!_.includes(["tdc_header_desktop","tdc_header_desktop_sticky"],f))continue;if("desktop_load"===k&&!_.includes(["tdc_header_mobile","tdc_header_mobile_sticky"],f))continue}e+=tdcSidebarPanel._bindParamAndGetHtml(c.params[g],b)}if("block_template_id"===k){n=d.block_template_id;_.isEmpty(n)&&(n=window.tdcAdminSettings.globalBlockTemplate);k=window.tdcAdminSettings.mappedBlockTemplates;for(var h=0;h<k[n].params.length;h++)if(a===tdcSidebarPanel._defaultGroupName&&
...
""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,
...
window.tdcPostSettings.mobileMenuId;c.set("attrs",d)}var f=!1,g=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(f=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(g=!0);var k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_disable_params")&&""!==a.toggle_disable_params&&(n='data-disable-params="'+a.toggle_disable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&
!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+a.toggle_enabled_by+'"');var l="";_.has(a,"toggle_disabled_by")&&""!==a.toggle_disabled_by&&(l='data-disabled-by="'+a.toggle_disabled_by+'"');var p=d="",x=!1,q=Object.keys(a.value),w=!0;if(_.has(a,"tdc_min_options")&&q.length<=parseInt(a.tdc_min_options))return d;for(var u=0;u<q.length;u++){var A=!1,B="",z="",r="",v="",y="",C=q[u],E=String(tdcSidebarPanel._getParameterCurrentValue(a,
c)),D=String(a.value[q[u]]);_.has(a,"options_to_disable")&&""!==a.options_to_disable&&(z=a.options_to_disable);_.has(a,"options_to_hide")&&""!==a.options_to_hide&&(r=a.options_to_hide);_.isObject(a.value[q[u]])&&(A=!0,D=_.values(a.value[q[u]])[0],C=_.keys(a.value[q[u]])[0]);if(f||g)0===u&&""===E&&(E=D),E===D&&(B=" checked "),z=_.uniqueId(),r=D,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(r="col_"+r),p+='<input class="tdc-property-input-radio" type="radio" '+
tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+z+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+B+' value="'+D+'">',f?(B="",A&&(B="tdc-standard-value"),p+='<label class="tdc-property-input-radio-label '+B+'" for="'+z+'" title="'+C+'"><div class="'+r+'"></div></label>'):p+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+C+'">'+D+"</label>";else{E===D&&(B=' selected="selected" ',w=!1);if("__"===D&&-1!==C.search("--")||-1<z.indexOf(D)&&""!==D)v=" disabled ";-1<r.indexOf(D)&&
""!==D&&(y=' style="display:none" ',"popular"===D&&(y=""));""!==v&&""!==B&&(x=!0);p+="<option "+B+" "+v+y+' value="'+D+'">'+C+"</option>"}}q="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':q=' title="'+a.description+'" ');d+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+k+" "+n+" "+h+" "+m+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+q+">"+a.heading+"</span>";b="";e="#";"tdb_flex_block_builder"!==
c.get("tag")&&"tdb_flex_loop_builder"!==c.get("tag")||"cloud_tpl_module_id"!==a.param_name||(b="tdc-edit-cloud_tpl_module_id",k='style="margin-left: 10px"',_.has(c.get("attrs"),"cloud_tpl_module_id")?""===c.get("attrs").cloud_tpl_module_id.trim()?k='style="margin-left: 10px; display: none"':"undefined"!==typeof window.tdData&&(e=tdData.adminUrl+"post.php?post_id="+c.get("attrs").cloud_tpl_module_id.trim()+"&td_action=tdc&tdbTemplateType=module"):k='style="margin-left: 10px; display: none"',d+='<a href="'+
e+'" class="'+b+'" target="_blank" '+k+">Edit</a>","dev"===window.td_deploy_mode&&(d+='<a href="#" class="tdc-refresh-cloud_tpl_module" target="_blank" style="margin-left: 10px">Refresh list</a>'));d+='</div><div class="tdc-property">';f||g?d+=p:(x&&(b+=" selected-op-disabled"),w&&["tds_plans_button","tds_plans_price"].includes(c.get("tag"))&&(f=String(tdcSidebarPanel._getParameterCurrentValue(a,c)),p+='<option selected="selected" value="'+f+'" disabled>Plan #'+f+" n/a</option>",b+=" selected-op-disabled"),
d+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" class="'+b+'">',d=d+p+"</select>");d=d+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return d+"</div>"},addDropDownResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=!1,f=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(d=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(f=!0);
var g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+'"');var h="",m="",l=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&l.length<=parseInt(a.tdc_min_options))return h;var p=' data-responsive="" ',
x=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var q=JSON.parse(window.atob(x));p=' data-responsive="'+x+'" ';"undefined"!==typeof q[tdcSidebar.currentViewportSettings.name]&&(x=q[tdcSidebar.currentViewportSettings.name])}catch(v){}for(q=0;q<l.length;q++){var w=!1,u="",A="",B=l[q],z=String(a.value[l[q]]);_.isObject(a.value[l[q]])&&(w=!0,z=_.values(a.value[l[q]])[0],B=_.keys(a.value[l[q]])[0]);if(d||f){0===q&&""===x&&(x=z);x===z&&(u=" checked ");A=_.uniqueId();var r=z;"vc_row"!==c.attributes.tag&&
"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(r="col_"+r);m+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+A+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+u+' value="'+z+'" '+p+">";d?(u="",w&&(u="tdc-standard-value"),m+='<label class="tdc-property-input-radio-label '+u+'" for="'+A+'" title="'+B+'"><div class="'+r+'"></div></label>'):m+='<label class="tdc-property-input-radio-label" for="'+A+'" title="'+
B+'">'+z+"</label>"}else x===z&&(u=' selected="selected" '),"__"===z.substring(0,2)&&-1!==B.search("--")&&(A=" disabled "),m+="<option "+u+" "+A+' value="'+z+'">'+B+"</option>"}l="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':l=' title="'+a.description+'" ');h+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+k+" "+n+">";h+='<div class="tdc-property-title"><span class="tdc-search-data"'+l+">"+a.heading+
'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';h+='<div class="tdc-property">';d||f?h+=m:(h+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+p+l+">",h=h+m+"</select>");h=h+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return h+"</div>"},addCheckBox:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+
'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="",g=tdcSidebarPanel._getParameterCurrentValue(a,c);"product_cat_type_action"===a.param_name?""!==g&&"single_selection"!==g&&(f=" checked "):""!==g&&(f=" checked ");var k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&
(n='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');var m="";_.has(a,"toggle_disabled_by")&&""!==a.toggle_disabled_by&&(m='data-disabled-by="'+a.toggle_disabled_by+'"');g="";var l=tdcSidebarPanel._getParameterClasses(a);l.includes("tdc-filter-multiple")&&(g=' title="'+a.description+'" ');b='<div class="'+l+'" '+b+" "+e+" "+k+" "+n+" "+h+" "+m+'><div class="tdc-property-title"><span class="tdc-search-data"'+
(d+">"+a.heading+"</span></div>");b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+f+" "+g+"/>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},addCheckBoxResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f=' data-responsive="" ',g=String(tdcSidebarPanel._getParameterCurrentValue(a,
c));try{var k=JSON.parse(window.atob(g));f=' data-responsive="'+g+'" ';"undefined"!==typeof k[tdcSidebar.currentViewportSettings.name]&&(g=k[tdcSidebar.currentViewportSettings.name])}catch(m){}""!==g&&(d=" checked ");k="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':k=' title="'+a.description+'" ');g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&
!0===a.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+n+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+k+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';
...
'" ');var f="";_.has(a,"range_max")&&""!==a.range_max&&(f=a.range_max);var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);var k="";_.has(a,"range_step")&&""!==a.range_step&&(k=a.range_step);var n="";_.has(a,"value")&&""!==a.value&&(n=a.value);var h="";""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(h=tdcSidebarPanel._getParameterCurrentValue(a,c));var m="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(m='data-enable-params="'+a.toggle_enable_params+'"');var l=
"";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(l='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+l+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,
c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+h+'" data-min="'+g+'" data-max="'+f+'" data-step="'+k+'" min="'+g+'" max="'+f+'" step="'+k+'" value="'+h+'" />');b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" value="'+h+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";
_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"range_max")&&""!==a.range_max&&(f=a.range_max);var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);var k="";_.has(a,"range_step")&&""!==a.range_step&&(k=a.range_step);var n="";_.has(a,"value")&&""!==a.value&&(n=a.value);""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&tdcSidebarPanel._getParameterCurrentValue(a,c);var h="";_.has(a,"placeholder")&&
""!==a.placeholder&&(h=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var m="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(m='data-enable-params="'+a.toggle_enable_params+'"');var l="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(l='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');var x=' data-responsive="" ',q=tdcSidebarPanel._getParameterCurrentValue(a,
c);try{var w=JSON.parse(window.atob(q));x=' data-responsive="'+q+'" ';q="undefined"===typeof w[tdcSidebar.currentViewportSettings.name]?"":w[tdcSidebar.currentViewportSettings.name]}catch(u){}b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+l+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
'" type="range" data-value="'+q+'" data-min="'+g+'" data-max="'+f+'" data-step="'+k+'" min="'+g+'" max="'+f+'" step="'+k+'" value="'+q+'" '+x+" />");b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" '+h+' value="'+q+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeMultiple:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&
...
c),m="",l="",p=[],x="",q="",w="",u="",A="",B="",z="",r;for(r in n)n.hasOwnProperty(r)&&(p.push(n[r].unit),""===q||""===x)&&(u=n[r].unit,q=' data-range_unit="'+u+'" ',w=n[r].value,x=' data-range_value="'+w+'" ',A=n[r].range_min,B=n[r].range_max,z=n[r].range_step);if(""!==h){for(var v=[],y=0;y<p.length&&!(v=h.split(p[y]),1<v.length);y++);v.length&&(u=p[y],q=' data-range_unit="'+u+'" ',w=v[0],x=' data-range_value="'+w+'" ')}for(r in n)n.hasOwnProperty(r)&&(h=_.uniqueId(),m+=" data-value_"+r+'="'+n[r].value+
'" ',m+=" data-min_"+r+'="'+n[r].range_min+'" ',m+=" data-max_"+r+'="'+n[r].range_max+'" ',m+=" data-step_"+r+'="'+n[r].range_step+'" ',p=n[r].value,v="",n[r].unit===u&&(p=w,A=n[r].range_min,B=n[r].range_max,z=n[r].range_step,v="checked"),l+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+r+'" data-unit_value="'+n[r].unit+'" type="radio" id="'+h+'" '+v+' data-default_value="'+n[r].value+'" data-last_value="'+p+'"/>',l+='<label for="'+h+'">'+n[r].unit+"</label>");b='<div class="'+
tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+x+" "+q+" "+m+' min="'+A+'" max="'+B+'" step="'+z+'" value="'+w+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+
l+'</div><input type="text" class="tdc_range_value" value="'+(w+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addRangeMultipleResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&
(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');var n=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),m="",l="",p=[],x=' data-responsive="" ',q="",w="",u="",A="",B="",z="",r="",v;for(v in n)n.hasOwnProperty(v)&&(p.push(n[v].unit),""===w||""===q)&&
(A=n[v].unit,w=' data-range_unit="'+A+'" ',u=n[v].value,q=' data-range_value="'+u+'" ',B=n[v].range_min,z=n[v].range_max,r=n[v].range_step);if(""!==h){var y=h;try{var C=JSON.parse(window.atob(h));x=' data-responsive="'+h+'" ';y="undefined"===typeof C[tdcSidebar.currentViewportSettings.name]?"":C[tdcSidebar.currentViewportSettings.name]}catch(E){}if(""!==y){h=[];for(C=0;C<p.length&&!(h=y.split(p[C]),1<h.length);C++);h.length&&(A=p[C],w=' data-range_unit="'+A+'" ',u=h[0],q=' data-range_value="'+u+'" ')}}for(v in n)n.hasOwnProperty(v)&&
(p=_.uniqueId(),m+=" data-value_"+v+'="'+n[v].value+'" ',m+=" data-min_"+v+'="'+n[v].range_min+'" ',m+=" data-max_"+v+'="'+n[v].range_max+'" ',m+=" data-step_"+v+'="'+n[v].range_step+'" ',y=n[v].value,h="",n[v].unit===A&&(y=u,B=n[v].range_min,z=n[v].range_max,r=n[v].range_step,h="checked"),l+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+v+'" data-unit_value="'+n[v].unit+'" type="radio" id="'+p+'" '+h+' data-default_value="'+n[v].value+'" data-last_value="'+y+'"/>',
l+='<label for="'+p+'">'+n[v].unit+"</label>");b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+q+" "+w+" "+m+" "+x+' min="'+B+'" max="'+z+'" step="'+r+'" value="'+
u+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+l+'</div><input type="text" class="tdc_range_value" value="'+(u+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addIconSelector:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+
'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
...
var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+
tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-image-wrap tdc-no-image-selected" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");b=b+'</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+
...
"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var g=jQuery("<div>"+a.description+"</div>");a.description===g.text()?d=' title="'+a.description+'" ':f='<div class="tdc-description">'+a.description+"</div>"}g="";_.has(a,"placeholder")&&""!==a.placeholder&&(g=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var k=tdcSidebarPanel._getParameterCurrentValue(a,
c);if(""===k){var n=Math.floor(65536*(1+Math.random())).toString(16).substring(1);"modal_id"===a.param_name?(k="td_m_"+n,tdcSidebarController.onUpdate(c,"modal_id","",k)):"tc_id"===a.param_name&&(k="td_tc_"+n,tdcSidebarController.onUpdate(c,"tc_id","",k))}"undefined"!==typeof k&&null!==k&&0===k.toString().indexOf("td_encval")&&(k=k.replace("td_encval",""),k=window.atob(k));n="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(n='data-enable-params="'+a.toggle_enable_params+'"');var h=
"";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+n+" "+h+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span>";d="";e="#";"tdm_block_popup"===c.get("tag")&&"page_id"===a.param_name&&(d="tdc-edit-page_id",
...
a.description+'"';else{var g=jQuery("<div>"+a.description+"</div>");a.description===g.text()?d=' title="'+a.description+'" ':f='<div class="tdc-description">'+a.description+"</div>"}g="";_.has(a,"placeholder")&&""!==a.placeholder&&(g=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&
...
b+" "+e+" "+k+" "+n+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" value="'+t+'" '+g+l+d+"/>");b=b+f+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+="</div>"},addTextArea:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+
'"');var d=_.uniqueId("tdc_textarea_"),f="",g="";if(_.has(a,"description")&&""!==a.description)if(""!==b)e='data-info-descr="'+a.description+'"';else{var k=jQuery("<div>"+a.description+"</div>");a.description===k.text()?f=' title="'+a.description+'" ':g='<div class="tdc-description">'+a.description+"</div>"}k="";_.has(a,"placeholder")&&""!==a.placeholder&&(k=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var l="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&
(l='data-enable-params="'+a.toggle_enable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+l+" "+h+" "+m+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+
(d+'" class="tdc-textarea tdc-textarea-visible" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+k+'">'+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");b=b+g+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";jQuery("body").on("keyup focusin","#"+d,function(a){var b=jQuery(a.target),c=tdcIFrameData.getModel(b.data("model_id"));if("focusin"!==a.type&&a.target.oldValue!==a.target.value){var d=b.val(),e=a.target.oldValue;
...
b)e='data-info-descr="'+a.description+'"';else{var k=jQuery("<div>"+a.description+"</div>");a.description===k.text()?f=' title="'+a.description+'" ':g='<div class="tdc-description">'+a.description+"</div>"}k="";_.has(a,"placeholder")&&""!==a.placeholder&&(k=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var l="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(l='data-enable-params="'+a.toggle_enable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&
!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+l+" "+h+" "+m+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(a,c)+" "+k+
...
a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b=b+'<div class="tdc-property-editor_expand"><span></span><div class="tdc-editor-toggle tdc-html-ace-editor-expand-collapse"></div></div><div class="tdc-property tdc-raw-html-ace"><textarea id="'+(d+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(a,
