...
tdcOperationUI.getDraggedElement(),e=tdcOperationUI.getCurrentElementOver(),c=tdcAdminWrapperUI.$placeholder,g="";if(!(b.isUndefined(a)||b.isUndefined(e)||b.isUndefined(c)||!c.is(":visible")&&e!==tdcAdminWrapperUI.$recycle)){var m=tdcOperationUI.isSidebarElementDragged(),n=tdcOperationUI.isElementDragged(),k=!1,l=!1,p=!1,q=!1,r=!1,u=!1,x=tdcOperationUI.isElementWithRowDragged(),t=tdcOperationUI.getRowStartValues();if(n){var w=a.closest(".tdc-elements");if(!m&&(g=tdcIFrameData._getSourceCol(tdcOperationUI.getDraggedElement()),
b.isUndefined(g)))return}else(k=tdcOperationUI.isInnerColumnDragged())&&(w=a.closest(".tdc-inner-columns"));!k&&(l=tdcOperationUI.isInnerRowDragged(),p=tdcOperationUI.isTempInnerRowDragged(),l||p)&&(w=a.closest(".tdc-elements"));l||p||(q=tdcOperationUI.isColumnDragged())&&(w=a.closest(".tdc-columns"));!q&&(r=tdcOperationUI.isRowDragged(),u=tdcOperationUI.isTempRowDragged(),r||u)&&(w=a.closest(".tdc-rows"));if(m||n||k||l||p||q||r||u){var B="",z=a.find(".td_block_inner");z.length&&(B=z.attr("id"));
if(!m&&!b.isUndefined(w)&&w.length){var v=w.children();z=v.index(a);var y=v.index(c);if(e!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(z-y))return;if(n||l||p||r||u){if((n||l||r)&&e===tdcAdminWrapperUI.$recycle){c="Deleting ";tdConfirm.showModal(l?c+"inner row":r?c+"row":c+"element",tdcOperationUI,function(){if((-1===y&&1===v.length||2===v.length&&-1!==y)&&(!r||1!==tdcIFrameData.tdcRows.length)){var b="";A=a.closest(".tdc-inner-column");A.length?b=" tdc-element-inner-column":(C=a.closest(".tdc-column"),
C.length&&(b=" tdc-element-column"));b=f('<div class="'+tdcOperationUI._emptyElementClass+b+'"></div>');tdcElementUI.bindEmptyElement(b);w.append(b)}tdcRecycle.takeSnapshot("Delete element");tdcOperationUI.setDraggedElement(a);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);tdcIFrameData.changeData({$refEl:tdcOperationUI.getDraggedElement(),wasSidebarElementDragged:m,wasElementDragged:n,wasInnerColumnDragged:k,wasInnerRowDragged:l,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:r,
wasTempRowDragged:u,wasElementWithRowDragged:x,rowStartValues:t,draggedBlockUid:B,sourceColParam:g});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(d);tdcOperationUI.setCurrentElementOver(d);tb_remove()},d,"Are you sure you want to delete this element?");return}if(-1===y&&1===v.length||2===v.length&&-1!==y){e="";var A=a.closest(".tdc-inner-column");if(A.length)e=" tdc-element-inner-column";else{var C=a.closest(".tdc-column");C.length&&(e=" tdc-element-column")}e=f('<div class="'+tdcOperationUI._emptyElementClass+
e+'"></div>');tdcElementUI.bindEmptyElement(e);w.append(e)}}}m&&(e="",n?e="tdc-element":p?e="tdc-element-inner-row-temp":l?e="tdc-element-inner-row":u?e="tdc-row-temp":r&&(e="tdc-row"),e=f('<div class="'+e+'">'+a.html()+"</div>"),b.isUndefined(a.data("shortcodeName"))||e.data("shortcodeName",a.data("shortcodeName")),b.isUndefined(a.data("startValues"))||e.data("startValues",a.data("startValues")),b.isUndefined(a.data("shortcodeContent"))||e.data("shortcodeContent",a.data("shortcodeContent")),b.isUndefined(a.data("rowStartValues"))||
...
q.cid),b.isUndefined(g)||(n.add(q,{at:h}),g.set("childCollection",n),q.set("childCollection",new tdcIFrameData.TdcCollection)),q.getShortcodeRender(1,a.draggedBlockUid,!0)):(l=JSON.parse(window.atob(l)).reverse(),b.map(l,function(d,e){setTimeout(function(){console.log(e);0!==e&&(c=f(c[0].outerHTML).insertBefore(c),c.html(""),c.addClass("tdc-dropped"));var m=new tdcIFrameData.TdcModel({templateContent:window.btoa(d),attrs:{},tag:"vc_row",type:"template",level:1,parentModel:g});new tdcIFrameData.TdcLiveView({model:m,
el:c[0]});h=c.prevAll(".tdc-row").length;c.data("model_id",m.cid);b.isUndefined(g)||(n.add(m,{at:h}),g.set("childCollection",n),m.set("childCollection",new tdcIFrameData.TdcCollection));m.getShortcodeRender(1,a.draggedBlockUid,!0)},500+2E3*parseInt(e,10))}));else if(a.wasColumnDragged){if(tdcRecycle.takeSnapshot("Column copied"),l=c.data("templateContent"),!b.isUndefined(l)){k=c.data("model_id");if(b.isUndefined(k)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,
...
g);b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",t));var w=0;for(b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}}else{if("13"===d&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),t=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",
t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}else if("23"===c)if("11"===d)if("12_12"===m)k=e.at(0),f=e.at(1),g=k.get("attrs"),h=f.get("attrs"),g=b.clone(g),h=b.clone(h),g.width="1/3",h.width="1/3",k.set("attrs",g),f.set("attrs",h),h=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,
parentModel:a}),e.add(h);else{if(e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),t=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a){a.set("parentModel",k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}else{if("13"===d&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=
b.clone(g),t=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}else if("13"===c)if("11"===d)if(""===m||"12_12"!==m&&"23_13"!==m&&"13_23"!==m&&"13_13_13"!==m){if(e.models.length)for(k=e.at(0),g=k.get("attrs"),
g=b.clone(g),t=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}else"12_12"===m&&e.models.length&&(k=e.at(0),f=e.at(1),g=k.get("attrs"),h=f.get("attrs"),g.width="1/3",h.width="1/3",k.set("attrs",g),f.set("attrs",
h),e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===d&&(""===m||"12_12"!==m)&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),t=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,k.set("childCollection",t)),w=0,b.each(e.models,function(a,c,d){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",
k);t.add(a)}))});0<w;)tdcIFrameData.removeModel(e.at(w)),w--}})}}},changeInnerRowModel:function(a,c,d){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(d))){var e=a.get("childCollection");if("11"!==c||"12_12"!==d&&"23_13"!==d&&"13_23"!==d&&"13_13_13"!==d)if("12_12"!==c&&"23_13"!==c&&"13_23"!==c||"11"!==d&&"12_12"!==d&&"23_13"!==d&&"13_23"!==d&&"13_13_13"!==d)"13_13_13"!==c||"11"!==d&&"12_12"!==d&&"23_13"!==d&&"13_23"!==d?tdcIFrameData.changeFluidStructureModel(a,c,d):("11"===d?(q=e.at(0),r=
...
c);_.isUndefined(c.getShortcode)||console.log(c.getShortcode)});c.on("click",".tdc-sidebar-current-styles-settings",function(b){b=tdcSidebarPanel.getCurrentStyleSettings(b);if(!_.isUndefined(b)){var c="",a;for(a in b)c+='"'+a+'" => "'+b[a]+'",\n';console.log(c)}});c.on("click",".tdc-sidebar-font-reset",function(b){tdConfirm.modal({caption:"Clear Font Settings",htmlInfoContent:"This will clear all values for this font group settings.",textYes:"Yes",objectContext:this,callbackYes:function(){tb_remove();
var b=jQuery(this),a=b.data("model_id"),c=tdcIFrameData.getModel(a),h=c.get("attrs");h=_.clone(h);for(var g="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),m="",f=0;f<g.length;f++){var k=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+g[f]+":first");if(k.length){var l=k.find('[data-model_id="'+a+'"]');l.length&&(l.val(""),l.data("responsive",""),k.removeClass("tdc-css-inherited"),m=k.find(".tdc-inherit"),m.length&&m.hide(),m=l.data("placeholder"),
"undefined"!==typeof m&&l.attr("placeholder",m),m=l.data("param_name"),delete h[m],l=l.attr("name"),tdcSidebarPanel.deleteResponsiveValues(l))}}c.set("attrs",h);tdcSidebarController.onUpdate(c,m,"","")}})});c.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var c=b.data("model_id");c=tdcIFrameData.getModel(c).get("attrs");var a=b.data("param_name").replace("font_settings",""),e="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" "),h={};
...
!0)}e||delete a[k]}break;case 3:h=e[0];m=e[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){q=p;break}e=!1;for(l in b)if(h===b[l]&&l===q+"-"+m){e=!0;break}e||_.has(b,q+"-"+m)&&""===b[q+"-"+m]&&window.tdcAdminSettings.globalStyle[q]===h&&(e=!0);e||delete a[k]}var r=[],u;for(u in window.tdcAdminSettings.listStyles[d])if(u===c){for(g=0;g<window.tdcAdminSettings.listStyles[d][u].length;g++)k=window.tdcAdminSettings.listStyles[d][u][g],_.isArray(k)?
...
b.length&&("popular1"===c||"popular2"===c||"popular3"===c||"popular7"===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"))},toggleEnableCFParams:function(c){var b=c.find("option:selected").text().match(/\(([^)]+)\)$/);c=jQuery(".tdc-separator-url, .tdc-property-url, .tdc-property-open_in_new_window, .tdc-property-url_rel");var d=jQuery(".tdc-property-text_cut");b&&(b=b[1],"wysiwyg"===b||"user"===b||"taxonomy"===b?c.addClass("tdc-disabled"):
c.removeClass("tdc-disabled"),"text"===b||"textarea"==b?d.removeClass("tdc-disabled"):d.addClass("tdc-disabled"))},bindPanelToModel:function(c,b){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==c.cid||!_.isUndefined(b)&&(_.isUndefined(b)||!0===b)){b=window.tdcAdminSettings.mappedShortcodes[c.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=c;for(var d=[],a=0;a<b.params.length;a++){var e=
tdcSidebarPanel._defaultGroupName;_.isEmpty(b.params[a].group)||(e=b.params[a].group);d.push(e)}d=_.uniq(d);var h=e="",g=tdcSidebar.getCurrentTabId(),m,f;e+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var k=f=m="";for(a=0;a<d.length;a++){h=tdcSidebarPanel._fixGroupName(d[a]);var l=tdcUtil.makeSafeForCSS(h);0===a?(m='<a href="#" data-tab-id="td-tab-'+l+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>',f='<a href="#" data-tab-id="td-tab-'+
l+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(g)||g!=="td-tab-"+l?k+='<a href="#" data-tab-id="td-tab-'+l+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>':(m=f,k+='<a href="#" data-tab-id="td-tab-'+l+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>')}e=e+(m+k)+"</div>";k=f=m=a="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":a=
...
b){tdcSidebarPanel.toggleEnableBlockSortParams(jQuery(b))});b=jQuery('[data-tag="tdb_single_custom_field"] [data-param_name="acf_field"]');b.length&&tdcSidebarPanel.toggleEnableCFParams(b);var q=jQuery('[data-tag="vc_column"] [data-param_name="is_sticky"], [data-tag="vc_column_inner"] [data-param_name="is_sticky"]');if(q.length){var r=q.closest(".tdc-property-wrap");jQuery("body").on("click",".tdc-responsive-buttons > div",function(a){a=q.is(":checked");jQuery(this).hasClass("tdc-responsive-phone")?
(r.addClass("tdc-disabled"),q.prop("disabled",!0),q.prop("checked",!1)):(r.removeClass("tdc-disabled"),q.prop("disabled",!1),q.prop("checked",a))})}}},_bindGroupAndGetHtml:function(c,b,d){var a="",e=d.get("attrs");if("tdc_zone"===d.get("tag"))var h=e.type;for(var g=0;g<b.params.length;g++){var m=b.params[g].param_name,f=b.params[g].group;if(c===tdcSidebarPanel._defaultGroupName&&_.isEmpty(b.params[g].group)||b.params[g].group===c){if(!_.isUndefined(h)){if(!_.isUndefined(b.params[g].zone_group)&&h!==
b.params[g].zone_group||"type"===m)continue;if("mob_load"===m&&!_.includes(["tdc_header_desktop","tdc_header_desktop_sticky"],h))continue;if("desktop_load"===m&&!_.includes(["tdc_header_mobile","tdc_header_mobile_sticky"],h))continue}a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[g],d)}if("block_template_id"===m){f=e.block_template_id;_.isEmpty(f)&&(f=window.tdcAdminSettings.globalBlockTemplate);m=window.tdcAdminSettings.mappedBlockTemplates;for(var k=0;k<m[f].params.length;k++)if(c===tdcSidebarPanel._defaultGroupName&&
...
""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(c,
...
window.tdcPostSettings.mobileMenuId;b.set("attrs",e)}var h=!1,g=!1;_.has(c,"tdc_dropdown_images")&&""!==c.tdc_dropdown_images&&(h=!0);_.has(c,"tdc_dropdown_texts")&&""!==c.tdc_dropdown_texts&&(g=!0);var m="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(m='data-enable-params="'+c.toggle_enable_params+'"');var f="";_.has(c,"toggle_disable_params")&&""!==c.toggle_disable_params&&(f='data-disable-params="'+c.toggle_disable_params+'"');var k="";_.has(c,"toggle_enable_params_reverse")&&
!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');var p="";_.has(c,"toggle_disabled_by")&&""!==c.toggle_disabled_by&&(p='data-disabled-by="'+c.toggle_disabled_by+'"');var q=e="",r=!1,u=Object.keys(c.value),x=!0;if(_.has(c,"tdc_min_options")&&u.length<=parseInt(c.tdc_min_options))return e;for(var t=0;t<u.length;t++){var w=!1,B="",z="",v="",y="",A="",C=u[t],E=String(tdcSidebarPanel._getParameterCurrentValue(c,
b)),D=String(c.value[u[t]]);_.has(c,"options_to_disable")&&""!==c.options_to_disable&&(z=c.options_to_disable);_.has(c,"options_to_hide")&&""!==c.options_to_hide&&(v=c.options_to_hide);_.isObject(c.value[u[t]])&&(w=!0,D=_.values(c.value[u[t]])[0],C=_.keys(c.value[u[t]])[0]);if(h||g)0===t&&""===E&&(E=D),E===D&&(B=" checked "),z=_.uniqueId(),v=D,"vc_row"!==b.attributes.tag&&"vc_row_inner"!==b.attributes.tag||-1!==c.param_name.indexOf("flex_")||(v="col_"+v),q+='<input class="tdc-property-input-radio" type="radio" '+
tdcSidebarPanel._getParamterDataAtts(c,b)+' id="'+z+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+B+' value="'+D+'">',h?(B="",w&&(B="tdc-standard-value"),q+='<label class="tdc-property-input-radio-label '+B+'" for="'+z+'" title="'+C+'"><div class="'+v+'"></div></label>'):q+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+C+'">'+D+"</label>";else{E===D&&(B=' selected="selected" ',x=!1);if("__"===D&&-1!==C.search("--")||-1<z.indexOf(D)&&""!==D)y=" disabled ";-1<v.indexOf(D)&&
""!==D&&(A=' style="display:none" ',"popular"===D&&(A=""));""!==y&&""!==B&&(r=!0);q+="<option "+B+" "+y+A+' value="'+D+'">'+C+"</option>"}}u="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':u=' title="'+c.description+'" ');e+='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+m+" "+f+" "+k+" "+l+" "+p+">";e+='<div class="tdc-property-title"><span class="tdc-search-data"'+u+">"+c.heading+"</span>";d="";a="#";"tdb_flex_block_builder"!==
b.get("tag")&&"tdb_flex_loop_builder"!==b.get("tag")||"cloud_tpl_module_id"!==c.param_name||(d="tdc-edit-cloud_tpl_module_id",m='style="margin-left: 10px"',_.has(b.get("attrs"),"cloud_tpl_module_id")?""===b.get("attrs").cloud_tpl_module_id.trim()?m='style="margin-left: 10px; display: none"':"undefined"!==typeof window.tdData&&(a=tdData.adminUrl+"post.php?post_id="+b.get("attrs").cloud_tpl_module_id.trim()+"&td_action=tdc&tdbTemplateType=module"):m='style="margin-left: 10px; display: none"',e+='<a href="'+
a+'" class="'+d+'" target="_blank" '+m+">Edit</a>","dev"===window.td_deploy_mode&&(e+='<a href="#" class="tdc-refresh-cloud_tpl_module" target="_blank" style="margin-left: 10px">Refresh list</a>'));e+='</div><div class="tdc-property">';h||g?e+=q:(r&&(d+=" selected-op-disabled"),x&&["tds_plans_button","tds_plans_price"].includes(b.get("tag"))&&(h=String(tdcSidebarPanel._getParameterCurrentValue(c,b)),q+='<option selected="selected" value="'+h+'" disabled>Plan #'+h+" n/a</option>",d+=" selected-op-disabled"),
e+="<select "+tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" class="'+d+'">',e=e+q+"</select>");e=e+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return e+"</div>"},addDropDownResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e=!1,h=!1;_.has(c,"tdc_dropdown_images")&&""!==c.tdc_dropdown_images&&(e=!0);_.has(c,"tdc_dropdown_texts")&&""!==c.tdc_dropdown_texts&&(h=!0);
var g="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(g='data-enable-params="'+c.toggle_enable_params+'"');var m="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(m='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(f='data-enabled-by="'+c.toggle_enabled_by+'"');var k="",l="",p=Object.keys(c.value);if(_.has(c,"tdc_min_options")&&p.length<=parseInt(c.tdc_min_options))return k;var q=' data-responsive="" ',
r=String(tdcSidebarPanel._getParameterCurrentValue(c,b));try{var u=JSON.parse(window.atob(r));q=' data-responsive="'+r+'" ';"undefined"!==typeof u[tdcSidebar.currentViewportSettings.name]&&(r=u[tdcSidebar.currentViewportSettings.name])}catch(y){}for(u=0;u<p.length;u++){var x=!1,t="",w="",B=p[u],z=String(c.value[p[u]]);_.isObject(c.value[p[u]])&&(x=!0,z=_.values(c.value[p[u]])[0],B=_.keys(c.value[p[u]])[0]);if(e||h){0===u&&""===r&&(r=z);r===z&&(t=" checked ");w=_.uniqueId();var v=z;"vc_row"!==b.attributes.tag&&
"vc_row_inner"!==b.attributes.tag||-1!==c.param_name.indexOf("flex_")||(v="col_"+v);l+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' id="'+w+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+t+' value="'+z+'" '+q+">";e?(t="",x&&(t="tdc-standard-value"),l+='<label class="tdc-property-input-radio-label '+t+'" for="'+w+'" title="'+B+'"><div class="'+v+'"></div></label>'):l+='<label class="tdc-property-input-radio-label" for="'+w+'" title="'+
B+'">'+z+"</label>"}else r===z&&(t=' selected="selected" '),"__"===z.substring(0,2)&&-1!==B.search("--")&&(w=" disabled "),l+="<option "+t+" "+w+' value="'+z+'">'+B+"</option>"}p="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':p=' title="'+c.description+'" ');k+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+g+" "+m+" "+f+">";k+='<div class="tdc-property-title"><span class="tdc-search-data"'+p+">"+c.heading+
'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';k+='<div class="tdc-property">';e||h?k+=l:(k+="<select "+tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+q+p+">",k=k+l+"</select>");k=k+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return k+"</div>"},addCheckBox:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+
'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="",g=tdcSidebarPanel._getParameterCurrentValue(c,b);"product_cat_type_action"===c.param_name?""!==g&&"single_selection"!==g&&(h=" checked "):""!==g&&(h=" checked ");var m="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(m='data-enable-params="'+c.toggle_enable_params+'"');var f="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&
(f='data-enable-params-reverse="1"');var k="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(k='data-enabled-by="'+c.toggle_enabled_by+'"');var l="";_.has(c,"toggle_disabled_by")&&""!==c.toggle_disabled_by&&(l='data-disabled-by="'+c.toggle_disabled_by+'"');g="";var p=tdcSidebarPanel._getParameterClasses(c);p.includes("tdc-filter-multiple")&&(g=' title="'+c.description+'" ');d='<div class="'+p+'" '+d+" "+a+" "+m+" "+f+" "+k+" "+l+'><div class="tdc-property-title"><span class="tdc-search-data"'+
(e+">"+c.heading+"</span></div>");d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="checkbox" value="yes" '+h+" "+g+"/>");d=d+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return d+"</div>"},addCheckBoxResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="",h=' data-responsive="" ',g=String(tdcSidebarPanel._getParameterCurrentValue(c,
b));try{var m=JSON.parse(window.atob(g));h=' data-responsive="'+g+'" ';"undefined"!==typeof m[tdcSidebar.currentViewportSettings.name]&&(g=m[tdcSidebar.currentViewportSettings.name])}catch(l){}""!==g&&(e=" checked ");m="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':m=' title="'+c.description+'" ');g="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(g='data-enable-params="'+c.toggle_enable_params+'"');var f="";_.has(c,"toggle_enable_params_reverse")&&
!0===c.toggle_enable_params_reverse&&(f='data-enable-params-reverse="1"');var k="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(k='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+g+" "+f+" "+k+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+m+">"+c.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';
...
"";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(p='data-enable-params-reverse="1"');var q="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(q='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+l+" "+p+" "+q+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,
b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" data-value="'+k+'" data-min="'+g+'" data-max="'+h+'" data-step="'+m+'" min="'+g+'" max="'+h+'" step="'+m+'" value="'+k+'" />');d=d+('<input type="text" class="tdc_range_value" data-default_value="'+f+'" value="'+k+'"/></div><span class="tdc-param-name">')+(c.param_name+"</span>");return d+="</div>"},addRangeResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";
...
""!==c.placeholder&&(k=' data-placeholder="'+c.placeholder+'" placeholder="'+c.placeholder+'" ');var l="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(l='data-enable-params="'+c.toggle_enable_params+'"');var p="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(p='data-enable-params-reverse="1"');var q="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(q='data-enabled-by="'+c.toggle_enabled_by+'"');var r=' data-responsive="" ',u=tdcSidebarPanel._getParameterCurrentValue(c,
b);try{var x=JSON.parse(window.atob(u));r=' data-responsive="'+u+'" ';u="undefined"===typeof x[tdcSidebar.currentViewportSettings.name]?"":x[tdcSidebar.currentViewportSettings.name]}catch(t){}d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+l+" "+p+" "+q+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+
'" type="range" data-value="'+u+'" data-min="'+g+'" data-max="'+h+'" data-step="'+m+'" min="'+g+'" max="'+h+'" step="'+m+'" value="'+u+'" '+r+" />");d=d+('<input type="text" class="tdc_range_value" data-default_value="'+f+'" '+k+' value="'+u+'"/></div><span class="tdc-param-name">')+(c.param_name+"</span>");return d+="</div>"},addRangeMultiple:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&
(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');var f=c.tdc_values,k=tdcSidebarPanel._getParameterCurrentValue(c,
b),l="",p="",q=[],r="",u="",x="",t="",w="",B="",z="",v;for(v in f)f.hasOwnProperty(v)&&(q.push(f[v].unit),""===u||""===r)&&(t=f[v].unit,u=' data-range_unit="'+t+'" ',x=f[v].value,r=' data-range_value="'+x+'" ',w=f[v].range_min,B=f[v].range_max,z=f[v].range_step);if(""!==k){for(var y=[],A=0;A<q.length&&!(y=k.split(q[A]),1<y.length);A++);y.length&&(t=q[A],u=' data-range_unit="'+t+'" ',x=y[0],r=' data-range_value="'+x+'" ')}for(v in f)f.hasOwnProperty(v)&&(k=_.uniqueId(),l+=" data-value_"+v+'="'+f[v].value+
'" ',l+=" data-min_"+v+'="'+f[v].range_min+'" ',l+=" data-max_"+v+'="'+f[v].range_max+'" ',l+=" data-step_"+v+'="'+f[v].range_step+'" ',q=f[v].value,y="",f[v].unit===t&&(q=x,w=f[v].range_min,B=f[v].range_max,z=f[v].range_step,y="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+'_unit" data-unit="'+v+'" data-unit_value="'+f[v].unit+'" type="radio" id="'+k+'" '+y+' data-default_value="'+f[v].value+'" data-last_value="'+q+'"/>',p+='<label for="'+k+'">'+f[v].unit+"</label>");d='<div class="'+
tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+r+" "+u+" "+l+' min="'+w+'" max="'+B+'" step="'+z+'" value="'+x+'"/>');d=d+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+
p+'</div><input type="text" class="tdc_range_value" value="'+(x+'"/>');d+="</div>";d+="</div>";d+='<span class="tdc-param-name">'+c.param_name+"</span>";return d+="</div>"},addRangeMultipleResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&
(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');var f=c.tdc_values,k=tdcSidebarPanel._getParameterCurrentValue(c,b),l="",p="",q=[],r=' data-responsive="" ',u="",x="",t="",w="",B="",z="",v="",y;for(y in f)f.hasOwnProperty(y)&&(q.push(f[y].unit),""===x||""===u)&&
(w=f[y].unit,x=' data-range_unit="'+w+'" ',t=f[y].value,u=' data-range_value="'+t+'" ',B=f[y].range_min,z=f[y].range_max,v=f[y].range_step);if(""!==k){var A=k;try{var C=JSON.parse(window.atob(k));r=' data-responsive="'+k+'" ';A="undefined"===typeof C[tdcSidebar.currentViewportSettings.name]?"":C[tdcSidebar.currentViewportSettings.name]}catch(E){}if(""!==A){k=[];for(C=0;C<q.length&&!(k=A.split(q[C]),1<k.length);C++);k.length&&(w=q[C],x=' data-range_unit="'+w+'" ',t=k[0],u=' data-range_value="'+t+'" ')}}for(y in f)f.hasOwnProperty(y)&&
(q=_.uniqueId(),l+=" data-value_"+y+'="'+f[y].value+'" ',l+=" data-min_"+y+'="'+f[y].range_min+'" ',l+=" data-max_"+y+'="'+f[y].range_max+'" ',l+=" data-step_"+y+'="'+f[y].range_step+'" ',A=f[y].value,k="",f[y].unit===w&&(A=t,B=f[y].range_min,z=f[y].range_max,v=f[y].range_step,k="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+'_unit" data-unit="'+y+'" data-unit_value="'+f[y].unit+'" type="radio" id="'+q+'" '+k+' data-default_value="'+f[y].value+'" data-last_value="'+A+'"/>',
p+='<label for="'+q+'">'+f[y].unit+"</label>");d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+u+" "+x+" "+l+" "+r+' min="'+B+'" max="'+z+'" step="'+v+'" value="'+
...
(c.param_name+"</span>");d+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(a,d){var e=jQuery(d);if(!e.parent().parent(".tdc-bg-upload").length&&c.param_name===e.data("param_name")){var h=tdcSidebarPanel._getParameterCurrentValue(c,b);""!==h&&jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_url","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
dataType:"json",data:{image_id:h,action:"tdc_ajax_get_image_url"}}).done(function(a,b,c){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(e.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),e.data("image_link",a.image_url),e.data("image_id",h),e.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,b,c){})}})});return d},addTextField:function(c,b){var d="",a="";_.has(c,
...
(n='data-enable-params="'+c.toggle_enable_params+'"');var k="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+n+" "+k+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><textarea id="'+
...
!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+n+" "+k+" "+l+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><textarea id="'+(e+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(c,b)+" "+f+
...
t=b.find(".tdc-css-border-radius").val().trim(),w=b.find(".tdc-css-width").val().trim(),B=b.find(".tdc-css-height").val().trim(),z=b.find(".tdc-css-shadow-size").val().trim(),v=b.find(".tdc-css-shadow-offset-h").val().trim(),y=b.find(".tdc-css-shadow-offset-v").val().trim(),A=b.find(".tdc-css-opacity").val().trim(),C=b.find(".tdc-css-gradient-direction").val().trim(),E=b.find(".tdc-css-z-index").val().trim(),D="";b.find(".tdc-css-order").length&&(D=b.find(".tdc-css-order").val().trim());""!==d&&(a["margin-top"]=
...
f);d=b.find(".tdc-css-border-color");f=d.val().trim();""!==f?a["border-color"]=f:(d=d.data("no_value"),c.isUndefined(d)||1!==d||(a["border-color"]="no_value"));""!==t&&(a["border-radius"]=t);""!==w&&(a.width=w);""!==B&&(a.height=B);""!==z&&(a["shadow-size"]=z);t=b.find(".tdc-css-shadow-color");w=t.val().trim();""!==w?a["shadow-color"]=w:(t=t.data("no_value"),c.isUndefined(t)||1!==t||(a["shadow-color"]="no_value"));""!==v&&(a["shadow-offset-h"]=v);""!==y&&(a["shadow-offset-v"]=y);v=b.find(".tdc-css-bg-color");
y=v.val().trim();""!==y?a["background-color"]=y:(v=v.data("no_value"),c.isUndefined(v)||1!==v||(a["background-color"]="no_value"));v=b.find(".tdc-css-bg-image");v.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(v=v.data("image_link"),c.isUndefined(v)||("no_value"===v?a["background-image"]="no_value":""!==v&&(a["background-image"]='url("'+v+'")')));v=b.find(".tdc-css-bg-style");y=v.val().trim();""===y||v.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||
(a["background-style"]=y);v=b.find(".tdc-css-bg-position");y=v.val().trim();""===y||v.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["background-position"]=y);""!==A&&(a.opacity=A);A=b.find(".tdc-css-color-1-overlay");v=A.val().trim();""!==v?a["color-1-overlay"]=v:(A=A.data("no_value"),c.isUndefined(A)||1!==A||(a["color-1-overlay"]="no_value"));A=b.find(".tdc-css-color-2-overlay");v=A.val().trim();""!==v?a["color-2-overlay"]=v:(A=A.data("no_value"),c.isUndefined(A)||
...
m.on("change keyup",".tdc-gradient-degree",function(b){b=f(this);a.degree=b.val().trim();a.mixedColors=a._getMixedColors();a._updateGradient();a._saveValue()})},value:h.alpha,step:1,min:0,max:100});if("undefined"!==typeof c.tdcAdminSettings.tdcSavings.recentColors&&c.tdcAdminSettings.tdcSavings.recentColors.length)for(w=c.tdcAdminSettings.tdcSavings.recentColors.length-1;0<=w;w--){t=c.tdcAdminSettings.tdcSavings.recentColors[w];try{z=JSON.parse(c.atob(t)),"undefined"!==typeof z&&(r=t="",/var\(--[a-zA-z0-9\-]*\)/.test(z)&&
